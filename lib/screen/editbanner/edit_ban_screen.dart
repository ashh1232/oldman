...
class EditBanScreen extends StatelessWidget {
  const EditBanScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // حقن الكنترولر ليتم استخدامه في الصفحة
    final EditBanController controller = Get.put(EditBanController());
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () async {
              await Get.toNamed(AppRoutes.addbanner);
