...
import 'package:manager/screen/admin/addproduct_screen.dart';
import 'package:manager/screen/admin/admin_order_details.dart';
import 'package:manager/screen/admin/edit_home_screen.dart';
import 'package:manager/screen/admin/edit_product_detail_view.dart';
import 'package:manager/screen/delivery/deli_map.dart';
import 'package:manager/screen/delivery/order_details.dart';
import 'package:manager/screen/home_screen.dart';
import 'package:manager/screen/talabat/favorites_screen.dart';
import 'package:manager/screen/talabat/map_tal.dart';
import 'package:manager/screen/talabat/talabat_home_screen.dart';
import 'package:manager/screen/talabat/checkout_screen.dart';
import 'package:manager/screen/delivery/deli_home.dart';
import 'package:manager/screen/edit/add_new_cat.dart';
import 'package:manager/screen/edit/edit_cat_details.dart';
import 'package:manager/screen/edit/edit_cat_screen.dart';
import 'package:manager/screen/editbanner/add_banner.dart';
import 'package:manager/screen/editbanner/edit_ban_details.dart';
import 'package:manager/screen/editbanner/edit_ban_screen.dart';
import 'package:manager/screen/talabat/order_confirmation_screen.dart';
import 'package:manager/screen/talabat/product_detail_view.dart';
import 'package:manager/screen/talabat/profile_screen.dart';
import 'package:manager/screen/talabat/cart_page.dart';
import 'package:manager/screen/auth/login_screen.dart';
import 'package:manager/screen/message_view.dart';
import 'package:manager/test/flut_map.dart';
import 'package:manager/trash/salon_screen.dart';
import 'package:manager/screen/auth/signup_screen.dart';
import 'package:manager/screen/talabat/category_page.dart';
